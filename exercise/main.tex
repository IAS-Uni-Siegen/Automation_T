...
%% add [solution]
\documentclass[solution, solution, solution, solution, solution, solution, solution, solution, solution, solution, solution, solution, solution, solution, solution, solution, solution, solution]{../course_template/exerciseClass}
\title{Automation Technologies}
