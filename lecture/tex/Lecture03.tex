...
\vspace{0.2cm}
\fbox{\parbox[c][2.0cm][c]{0.9\linewidth}{\centering Insert a generic ``frequency response'' sketch here (gain vs.\ $f$ for LPF/HPF/BPF/BSF)}}
\end{frame}
...
\]
(The minus sign corresponds to the reference chosen in the book.)
\end{block}
...
\vspace{0.2cm}
\fbox{\parbox[c][2.0cm][c]{0.9\linewidth}{\centering Insert Figure 9.1: CR low–pass circuit}}
\end{frame}
...
\vspace{0.2cm}
\fbox{\parbox[c][2.0cm][c]{0.9\linewidth}{\centering Insert Figure 9.2: Bode magnitude and phase for first–order LPF}}
\end{frame}
