...
%------------------------------------------------
\begin{frame}{Weighted Resistor DAC: Principle}
  \begin{columns}
...
%------------------------------------------------
\begin{frame}{Flash (Parallel) ADC}
  \begin{columns}
  \column{0.5\textwidth}
\begin{itemize}
...
%------------------------------------------------
\begin{frame}{Successive Approximation ADC}
  \begin{columns}
  \column{0.5\textwidth}
...
%------------------------------------------------
\begin{frame}{Counter-Ramp (Integrating) ADC}
  \begin{columns}
      \column{0.5\textwidth}
...
%------------------------------------------------
\begin{frame}{Delta--Sigma Charge-Balance ADC: Principle}
  \begin{columns}
    \column{0.5\textwidth}
...
%------------------------------------------------
\begin{frame}{Delta--Sigma Charge-Balance ADC: Operation}
\begin{columns}
    \column{0.5\textwidth}
